...
public class AuthController {
    ...
    public ResponseEntity<DataResponseDto<TokenDto>> refresh(@RequestBody RefreshTokenDto refreshTokenDto, @AuthenticationPrincipal CustomUserDetails principal) {
        TokenDto refreshedToken = authService.reissueAccessToken(principal.getUserId(), refreshTokenDto);
        return ResponseEntity.status(HttpStatus.OK)
