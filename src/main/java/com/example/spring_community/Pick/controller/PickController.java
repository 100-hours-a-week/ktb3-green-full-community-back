...
public class PickController {
    ...
    public ResponseEntity<DataResponseDto<PickDto>> isLiked(@PathVariable Long postId, @AuthUser AuthUserDto authUserDto) {
        PickDto pick = pickService.getPickNumber(postId, authUserDto.getUserId());
    ...
    public ResponseEntity<DataResponseDto<PickDto>> addLikes(@PathVariable Long postId, @RequestBody PickDto pickDto, @AuthUser AuthUserDto authUserDto) {
        PickDto pick = pickService.addPick(postId, authUserDto.getUserId(), pickDto.getPickNumber());
    ...
    public ResponseEntity<DataResponseDto<PickDto>> deleteLikes(@PathVariable Long postId,@RequestBody PickDto pickDto, @AuthUser AuthUserDto authUserDto) {
        PickDto pick = pickService.deletePick(postId, authUserDto.getUserId(), pickDto.getPickNumber());
        return ResponseEntity.status(HttpStatus.OK)
